...
return (
        ...
        <p className='texto'>I have experience with a variety of programming languages and web technologies, including HTML, CSS, JavaScript, React, Angular and Node.js.</p>
        ...
        <ul>
          ...
          <li>English C1</li>
          <li>French B1</li>
          <li>Associate in Software Development</li>
        </ul>
        </div>
      );
}
